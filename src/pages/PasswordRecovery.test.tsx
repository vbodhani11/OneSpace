...
describe('password recovery', () => {
  ...
  it('requests a reset without revealing whether the account exists', async () => {
    ...
    expect(screen.getByRole('status')).toHaveTextContent('Each link works only once');
  });

  it('replaces a raw reset-email rate limit with useful instructions', async () => {
    ...
    expect(alert).toHaveTextContent('Too many reset links were requested');
    expect(alert).toHaveTextContent('use only the newest email');
